...
I'm excited to apply for the **Software Engineer, C++** role. A quick fit snapshot:
...
---
**Keyword Alignment (ATS-safe):** c++, communication, computer vision, data, documentation, engineer, frontend, learning, performance, python, react, software, support, typescript, workflows
