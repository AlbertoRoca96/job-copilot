...
---
**Keyword Alignment (ATS-safe):** ai, automation, c++, ci, computer vision, data, engineer, inference, learning, machine, machine learning, python, pytorch, software, support, workflows, communication
